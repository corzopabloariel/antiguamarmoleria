...
Pyrus = function (e = null, dataPYRUS = null, modify = null) {
    ...
    this.inputImage = (Object_, Arr, OBJ_funcion) => {
        ...
        if (Object_.WIDTH) {
            ...
            attr_html += `<li>Ancho [sin definir]</li>`;
        if (Object_.HEIGHTop)
            attr_html += `<li>Alto [${Object_.HEIGHTop}]</li>`;
        else if (Object_.HEIGHT) {
            attr_html += `<li>Alto [${Object_.HEIGHT}]</li>`;
            image.style.height = Object_.HEIGHT;
        } else
            attr_html += `<li>Alto [sin definir]</li>`;
        if (Object_.SIZE)
            attr_html += `<li>Peso [${Object_.SIZE}]</li>`;
        else
            attr_html += `<li>Peso [Sin definir]</li>`;
        attr_html += "</ul>";
