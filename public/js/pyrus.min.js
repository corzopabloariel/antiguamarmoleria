...
//Pyrus = function (e = null, dataPYRUS = null, modify = null) {
    ...
    static relation(e, attr = null, order = null, callbackOK = null) {
     ...
     * @returns string
     */
    table = ( columns = null , replace = false ) => {
    ...
    convert = (value, target, url, type, specification, elements, column, id) => {
        ...
        switch(type) {
            ...
            case "TP_CHECK":
                ...
                btn_element.dataset.name = this.name;
                ...
                if (specification.OPTION) {
                    ...
                    target.textContent = "-";
                target.innerHTML += btn_element.outerHTML;
            break;
            case "TP_YOUTUBE":
            ...
            case "TP_COLOR":
                ...
                elem.innerHTML = `<p>${value[column.COLUMN]}${btn_element.outerHTML}</p>`;
            ...
            case "TP_EMAIL":
                ...
                target.innerHTML = value + btn_element.outerHTML;
            break;
            case "TP_FECHA":
            case "TP_DATE":
    ...
    row = (elements, url, tbody, id, buttonsOK, button) => {
        ...
        if (buttonsOK.length != 0 || button !== null) {
            ...
            let buttons = `<td class="text-center" style="width:200px; max-with: 200px">`;
    ...
    one = ( url , callbackOK , callbackFail = null ) => {
        axios.get( url, {
            responseType: 'json'
        })
        .then(function( res ) {
                ...
                for(let i in rowElements) {
                    ...
                    rowElementos.forEach( e => {
                        ...
                        if(e != "VACIO") {
                            ...
                            aux = this.inputAdecuado(especificacion, e, id, OBJ_funcion, especificacion.PLACEHOLDER === undefined ? "" : especificacion.PLACEHOLDER, multiple);
    ...
    listDatails = (OBJ_elemento, Arr, STR_class, OBJ_funcion = null , placeholder = "", value = null) => {
        let element = document.createElement("input");
    ...
    async dataRelation(Object_, Arr, OBJ_funcion, value) {
        ...
        const elem = {TIPO:"TP_ENUM",VISIBILIDAD: Object_.VISIBILIDAD,ENUM:data.data.data,RULE: Object_.RULE, NECESARIO: Object_.NECESARIO, LABEL: Object_.LABEL,NOMBRE:Object_.NOMBRE,CLASS:"form--input", NECESARIO: Object_.NECESARIO, NORMAL: 1};
