...
Pyrus = function (e = null, dataPYRUS = null, modify = null) {
    ...
    this.convert = (value, target, url, type, specification, elements, column) => {
        ...
        switch(type) {
            ...
            case "TP_COLOR":
                ...
                btn_color.classList.add("btn", "button--form", "btn-link", "btn-sm", "ml-2", "edit--check");
                btn_color.innerHTML = '<i class="fas fa-pen"></i>';
                btn_color.type = "button";
                btn_color.dataset.name = this.name;
                btn_color.dataset.column = column.COLUMN;
                btn_color.dataset.id = id;
                btn_color.dataset.value = value;
                ...
                target.innerHTML += btn_color.outerHTML;
            break;
            case "TP_LINK":
     ...
     * @var e @type String
     */
    this.inputAdecuado = (Object_, element_name, id_name, OBJ_funcion, placeholder , multiple, value = null, add = null) => {
        let names = this.constructorNames({
    ...
    //-----------
    this.check = (OBJ_elemento, Arr, OBJ_funcion = null, value = null) => {
    ...
    this.listDatails = (OBJ_elemento, Arr, STR_class, OBJ_funcion = null , placeholder = "", value = null) => {
        let element = document.createElement("input");
    ...
    this.select = (Object_, Arr, OBJ_funcion, value) => {
