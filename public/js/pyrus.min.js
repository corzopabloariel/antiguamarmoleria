    ...
    convert = (value, target, url, type, specification, elements, column, id) => {
        ...
        switch(type) {
            ...
            case "TP_EMAIL":
                ...
                target.innerHTML = `<div class="d-flex justify-content-between align-items-center">${value}${btn_element.outerHTML}</div>`;
            break;
            case "TP_FECHA":
            case "TP_DATE":
                btn_element.classList.add("btn", "button--form", "btn-link", "btn-sm", "ml-2", "edit--check");
                ...
                target.innerHTML = `<div class="d-flex justify-content-between align-items-center">${value[1]}${btn_element.outerHTML}</div>`;
            break;
            case "TP_MONEY":
